...
export function createReviewEvidence({environment, ui, reviewState, api, fieldSchema}) {
  ...
  function renderArtifacts() {
    ...
    const artifacts = reviewState.current?.processing_artifacts?.[reviewState.artifactTab] || [];
